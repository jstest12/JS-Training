var RatesWidget = function(name, into) {
	...
	addListItem = function(text, value) {
		...
		var container = document.getElementById(into);
		container.appendChild(divItem);
	},
	/* ElentListener */
	updRates = function() {
		var divId = document.getElementById(into);
		var curr = divId.getElementsByClassName('currValueText');
		for (var f in curr) {
	...
	return {
        getExRates: function(option) {
			...
			req.open('GET', 'http://openexchangerates.org/' + 'latest.json', true);
